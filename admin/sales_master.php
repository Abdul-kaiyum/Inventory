...
if (isset($_POST['submit1'])) {
    $lastbillno=0;
    mysqli_query($link, "insert into billing_header values(NULL, '$_POST[full_name]','$_POST[bill_type]','$_POST[bill_date]','$_POST[bill_no]', '$_SESSION[admin]')") or die(mysqli_error($link));
