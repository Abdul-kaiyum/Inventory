...
mysqli_query($link, "insert into return_products values(NULL, '$_SESSION[user]','$bill_no', '$today_date','$product_company','$product_name','$product_unit','$product_size','$price','$qty','$total') ");
