...
<div id="loginbox">
    <form name="form1" class="form-vertical" action="" method="post">
        <div class="control-group normal_text"><h4>CMH Storage Management Software </h4></hr>
            <h2><b class="text-info">User Login Page</b></h2></div>
        ...
        <div class="form-actions">
            ...
            <center>
                <input type="submit" name="submit" value="Login" class="btn btn-success" required />
                 ...
                 if ($count>0) {
                    ...
                    ?>
                           <div class="alert alert-danger">
                            ...
                            Invalid username and password or account blocked by admin
                           </div>
